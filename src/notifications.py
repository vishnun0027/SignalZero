...
def format_discord_embed(signal_type: str, confidence: float, trigger_details: dict, brief: str) -> dict:
...
def send_discord_notification(signal_type: str, confidence: float, trigger_details: dict, brief: str) -> bool:
...
def send_slack_notification(signal_type: str, confidence: float, trigger_details: dict, brief: str) -> bool:
...
def dispatch_notifications(signal_type: str, confidence: float, trigger_details: dict, brief: str) -> bool:
...
def send_weekly_digest_discord(signals: list) -> bool:
...
def send_weekly_digest_slack(signals: list) -> bool:
